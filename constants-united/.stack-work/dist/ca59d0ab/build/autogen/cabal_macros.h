...
/* package constants-united-0.1.0.0 */
#define VERSION_constants_united "0.1.0.0"
#define MIN_VERSION_constants_united(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
/* package threepenny-gui-0.7.0.1 */
#define VERSION_threepenny_gui "0.7.0.1"
...
#define CURRENT_COMPONENT_ID "constants-united-0.1.0.0-Dsw9qjzcukv1YjvdfUjtl9"

#define CURRENT_PACKAGE_KEY "constants-united-0.1.0.0-Dsw9qjzcukv1YjvdfUjtl9"
