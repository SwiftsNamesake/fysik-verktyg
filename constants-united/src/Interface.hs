...
setup w = do
  ...
  getBody w #+ [column $ row [element button1, element button2, element button3, element button4] : map mkString (words "Many different elements")]
...
-- |
runApplication :: IO ()
runApplication = startGUI defaultConfig setup